...
WalletdRPC.prototype.reset = function (opts) {
...
WalletdRPC.prototype.getMnemonicSeed = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
WalletdRPC.prototype.createIntegratedAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
WalletdRPC.prototype.getFeeInfo = function () {
  return new Promise((resolve, reject) => {
